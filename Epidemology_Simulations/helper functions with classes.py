...
def simulationWithoutDrug(numViruses, maxPop, maxBirthProb, clearProb,
    ...
    """
    numSteps = 300
    trialResults = [[] for s in range(numSteps)]
    ...
    pylab.plot(resultsSummary, label="Virus Population")
...
print simulationWithoutDrug(100, 1000, 0.1, 0.05, 1)
...
class ResistantVirus(SimpleVirus):
    ...
    def reproduce(self, popDensity, activeDrugs):
        ...
        if (all(self.isResistantTo(drug) for drug in activeDrugs) and
            ...
            resistances = {key:value if random.random() > self.mutProb else not value
...
print simulationWithDrug(100, 1000, 0.1, 0.05, {"guttagonol": True}, 0.005, 100)
print simulationWithDrug(100, 1000, 0.1, 0.05, {"guttagonol": False}, 0.005, 100)
print simulationWithDrug(100, 1000, 0.1, 0.05, {'guttagonol': False, 'grimpex': False}, 0.005, 100)
