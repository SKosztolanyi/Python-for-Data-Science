...
class intDict(object):
    ...
    # I prepare an empty dictionary for future hashing into its keys.
    # The size of buckets can vary     
...
print collision_prob(365, 58) 
# probability that 58 people have birthday at the same day

print observe_prob(1000, 50, 1000)
# observed probability of collision with 50 insertions into 1000 buckets over 1000 tries
