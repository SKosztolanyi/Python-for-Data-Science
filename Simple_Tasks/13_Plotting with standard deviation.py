...
# This is a function of standard deviation
def stdDev(X):
...
# This one trial can be used to calculate number of heads in tails in certain number of flips
def runTrial(numFlips):
    ...
    # returns a tuple, absolute values of tails and heads
...
def flipPlot(minExp, maxExp, numTrials):
    ...
    pylab.semilogx() # logarithmic line instead of linear
    pylab.figure()
...
# Added number of trials for every number of flips
# Example - For 4 coinflips, there will be 20 trials and plottet will be standard deviation as well as mean value of the flips.
