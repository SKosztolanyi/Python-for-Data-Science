...
# We want to find the maximum clique in a graph, that means, we want to find
# the biggest subgroup in a graph,
# where every node is connected with every other node.
